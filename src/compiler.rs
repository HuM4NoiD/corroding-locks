...
use crate::{
    chunk::{Chunk, OpCode},
    scanner::Scanner,
    token::{Token, TokenType}, debug::disassemble_chunk,
};
...
impl Parser {
    ...
    fn emit_constant(&mut self, constant: f64, chunk: &mut Chunk) {
    ...
    fn make_constant(&mut self, constant: f64, chunk: &mut Chunk) -> u8 {
